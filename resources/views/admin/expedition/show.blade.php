            ...
            <div class="ms-auto">
                <div class="btn-group">
                    ...
                    <form action="{{ route('admin.expedition.ToStarted', ['uuid' => $expedition->uuid]) }}" method="POST" class="submitForm">
                        @csrf
                        <button type="submit" class="text-white rounded btn btn-primary" onclick="return confirmSubmission(event)">Soumettre</button>
                    </form>
                    @endif
                        ...
                        <div class="step" data-target="#test-l-2">
                            <div class="step-trigger" role="tab" id="stepper1trigger2" aria-controls="test-l-2">
                                ...
                                <div class="text-center">
                                    ...
                                    <span> {{$expedition->date_started ? Carbon\Carbon::parse($expedition->date_started)->format('d/m/y') : '--'}}</span>
                                </div>
