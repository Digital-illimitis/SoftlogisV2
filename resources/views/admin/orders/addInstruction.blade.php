<div class="modal fade" id="addInstruction" tabindex="-1" aria-hidden="true">
    <div class="page-content">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title size_16">Instruction de commande</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body page-content size_13">
                    <form action="{{ route('admin.orders.store') }}" method="POST" enctype="multipart/form-data" class="submitForm">
                        @csrf
                        <div id="t" role="tabpanel" class="bs" aria-labelledby="">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-12 col-lg-6">
                                    <label for="num_exp" class="form-label">N° Dossier</label>
                                    <input type="text" class="form-control" id="num_exp" name="num_exp">
                                </div>
