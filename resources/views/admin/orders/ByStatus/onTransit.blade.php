<div class="modal fade" id="showOrderOnTransitModal" tabindex="-1" aria-labelledby="showOrderOnTransitModal" aria-hidden="true"  >
    <div class="modal-dialog" style="min-width: 1000px">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="showOrderOnTransitModal">Vue sur les commandes</h5>
                ...
                <div class="table-responsive mt-2" >
                    <table class="table table-striped table-hover table-sm mb-0" id="example2">
                        ...
                        <tbody>
                            ...
                            @forelse ($orderOnTransit as $item)
                            <tr>
                                <td>
