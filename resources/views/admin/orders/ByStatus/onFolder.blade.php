<div class="modal fade" id="showViewOrderbystatusModal" tabindex="-1" aria-labelledby="showViewOrderbystatusModal" aria-hidden="true"  >
    <div class="modal-dialog" style="min-width: 1000px">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="showViewOrderbystatusModal">Vue sur les commandes</h5>
                ...
                <div class="table-responsive mt-2" >
                    <table class="table table-striped table-hover table-sm mb-0" id="example2">
                        ...
                        <tbody>
                            ...
                            @forelse ($orderOnDocument as $item)
                            <tr>
                                <td>
