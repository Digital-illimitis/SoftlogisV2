        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Family Group</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-lg-flex align-items-center mb-4 gap-3">
              <div class="ms-auto">
                <button type="button" class="btn btn-primary radius-30 mt-2 mt-lg-0" data-bs-toggle="modal" data-bs-target="#addGroupModal"><i class="bx bxs-plus-square"></i>Ajouter</button>
              </div>
                            ...
                            <td>
                                <div class="d-flex order-actions">
                                    ...
                                    <a class="ms-3 deleteConfirmation" data-uuid="{{$item->uuid}}"
                                        ...
                                        data-url="{{route('admin.destroyFamillyGroup',$item->uuid)}}"
                                        data-title="Vous êtes sur le point de supprimer {{$item->libelle}} "
                                        data-id="{{$item->uuid}}" data-param="0"
                                        data-route="{{route('admin.destroyFamillyGroup',$item->uuid)}}"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nouveau Group</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('admin.store.familly.group') }}" method="post" class="submitForm">
