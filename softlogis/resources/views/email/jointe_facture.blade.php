                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="{{ asset('assets/images/logo-icon.png') }}"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div style="margin-top:10px;">
                                                <a href="{{ asset($cum) }}" 
                                                   download 
                                                   style="display:inline-block;padding:10px 20px;background-color:#2F67F6;color:#fff;text-decoration:none;border-radius:5px;font-size:14px;">
                                                    <i class="bx bxs-file-pdf size_16">Télécharger PDF</i>
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                Best regards,<br><br> SoftLogis<br>JALO Logistics<br>
                                                <a href="https://softlogis.com/"
                                                    style="color:#2F67F6">softlogis.com</a>
                                            </div>
