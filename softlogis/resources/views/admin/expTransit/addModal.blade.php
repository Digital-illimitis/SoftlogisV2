        ...
        <div class="modal-content">
            ...
            <div class="modal-body size_13" id="stronger">
                <form action="{{ route('admin.transit.to_expedition.store') }}" method="POST" enctype="multipart/form-data" class="submitForm row">
                    ...
                    @endif
                    <input type="hidden" name="typeOp" value="export">
                    <div class="col-12">
                    ...
                    <div class="row col-12 my-4">
                        ...
                        <div class="row my-3">
                            <div class="col form-group">
                                <label for="date_transit" class="form-label border-0 text-uppercase size_14">Date de transit</label>
                                <input type="date" name="date_transit" class="form-control size_13">
                            </div>
                        </div>
                                ...
                                <div class="row add_new_prod gx-1 px-0 mb-3" id="0">
                                    ...
                                    <div class="col-4">
                                        <select class="form-select selectedProductUuid" data-placeholder="Choisir article" name="product_uuid[]">
                                            <option></option>
                                            @foreach ($expedition->products as $item)
                                                <option value="{{ $item->product->uuid }}" data-uuid="{{ $item->product->uuid }}">{{ $item->product->numero_serie ?? '--' }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-3">
                                        <input type="text" class="form-control px-0 text-center designation" placeholder="niveleuse" disabled>
                                    </div>
                                    <div class="col-2">
                        ...
                        <div class="col-12 my-4">
                            <label for="note" class="form-label text-uppercase">Intructions particulières </label>
