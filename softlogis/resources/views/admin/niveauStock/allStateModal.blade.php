                        ...
                        <table id="example2" class="table table-hover table-striped table-bordered">
                            <thead class="table-primary">
                                <tr>
                                    ...
                                    <th>Famille</th>
                                    <th>Modèle</th>
                                    <th>Statut Materiels</th>
                                    <th>Valeur (FCFA)</th>
                                    <th>Bill Of Lading</th>
                                    <th>Entrepôt</th>
                                    <th>N° Dossier</th>
                                    <th>ETA</th>
                                    <th>Date Déclaration Import</th>
                                    <th>N° Déclaration</th>
                                    <th>Réception</th>
                                    <th>Date d'entree en stock</th>
                                    <th>Poids (T)</th>
                                    <th>Hauteur</th>
                                    <th>Largeur</th>
                                    <th>Volume</th>
                                    <th>Longueur</th>
                                    <th>Client/Filliale</th>
                                    <th>N° Commande</th>
                                    <th>Date d'instruction de commande</th>
                                    <th>Lieu Livraison</th>
                                    <th>Régime de sortie</th>
                                    <th>Date declaration export</th>
                                    <th>N°Declaration Export</th>
                                    <th>Date de Chargement</th>
                                    <th>Date de T1</th>
                                    <th>Date de Sortie de stock</th>
                                    {{-- <th>Expédition</th> --}}
                                    <th>Date d'arrivee filliale</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($delivered as $item)
                                    @php
                                        ...
                                        $familyGRp = DB::table('familly_groups')->where('uuid', $item->familyGroup)->first();
                                    @endphp
                                    <tr data-category_uuid="{{ strtolower($item->category_uuid) }}">
                                        ...
                                        <td>{{ number_format($item->price_unitaire) ?? '--' }}</td>
                                        ...
                                        <td>{{ $expedition->declarationNum ?? '--' }}</td>
