...
<div class="page-content">
    ...
    @if (Auth::user()->organisation == 'transitaire')
        @include('transitaire.dashboard')
    @elseif (Auth::user()->organisation == 'transporteur')
        @include('transporteur.dashboardComponent')
    @elseif (Auth::user()->organisation == 'client')
        @include('admin.client.dashboardComponent')
    @else
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--<div class="dropdown ms-auto">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:;">Stock previsionel</a>
                                </li>
                                <li>
                        ...
                        <div class="mb-0 bottom-0 card-footer h-25">
                            <ul class="list-group list-group-flush">
                                <li
                                    ...
                                    Total Entrée <span class="badge bg-info rounded-pill">{{ $InStock->count() }}</span>
                                </li>
                                <li
                    ...
                    <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3" id="switchBtnImportGroup">
                        ...
                        <span class="border px-1 rounded cursor-pointer" id="btnswitchtransport"
                            onclick="switchDisplayTransport('blockTransport')"><i class="bx bxs-circle me-1"
                                style="color: #ff7220"></i>Marchandises Importées</span>
                    </div>
    ...
    <div class="col-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                                            <div class="card-body cursor-pointer" data-bs-toggle="modal"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="mb-0 text-secondary font-14 text-uppercase">Démarrage
                                                            Document</p>
                            ...
                            <div class="col-12 col-lg-8 d-flex">
                                <div class="card radius-10 w-100">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <h6 class="mb-0 text-uppercase">Expédition</h6>
                                            </div>
                                            <!---<div class="dropdown ms-auto">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mx-0 px-0" id="blockGlobalExp">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">Attente de validation des documents<span
                                                                class="float-end">{{ number_format($percentageExpGlobal, 2) }}%</span></p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-ibiza"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpGlobal, 2) }}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">En Transit<span
                                                                class="float-end">{{ number_format($percentageExpTransit, 2) }}%</span>
                                                        </p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-deepblue"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpTransit, 2) }}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">En Cours d'Expédition<span
                                                                class="float-end">{{ number_format($percentageExpWaitExp, 2) }}%</span>
                                                        </p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-ohhappiness"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpWaitExp, 2) }}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">Expédié/Livré au client <span
                                                                class="float-end">{{ number_format($percentageExpDelivered, 2) }}%</span>
                                                        </p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-orange"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpDelivered, 2) }}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mx-0 px-0" id="blockMensuelExp" style="display: none">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">Attente de validation des documents <sup
                                                            ...
                                                            <span
                                                                class="float-end">{{ number_format($percentageExpWaitDocMensuel, 2) }}%</span>
                                                        </p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-ibiza"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpWaitDocMensuel, 2) }}%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">En Transit<sup
                                                                ...
                                                                class="float-end">{{ number_format($percentageExpDemarrerMensuel, 2) }}%</span>
                                                        </p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-deepblue"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpDemarrerMensuel, 2) }}%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">En Cours d'Expédition <sup
                                                                class="badge rounded-pill bg-gradient-ohhappiness">{{ $countExpWaitingPerMonth }}</sup><span
                                                                class="float-end">{{ number_format($percentageExpWaitingMensuel, 2) }}%</span>
                                                        </p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-ohhappiness"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpWaitingMensuel, 2) }}%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <p class="mb-2">Expédié/Livré au client <sup
                                                                class="badge rounded-pill bg-gradient-orange">{{ $countExpReadyPerMonth }}</sup>
                                                            <span
                                                                class="float-end">{{ number_format($percentageExpReadyMensuel, 2) }}%</span>
                                                        </p>
                                                        <div class="progress" style="height: 5px;">
                                                            <div class="progress-bar bg-gradient-orange"
                                                                role="progressbar"
                                                                style="width: {{ number_format($percentageExpReadyMensuel, 2) }}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="col">
                                            <div class="p-3">
                                                <h5 class="mb-0">{{ number_format($averageDelayExpedite, 2) }} /jour</h5>
                                        ...
                                        <div class="col">
                                            <div class="p-3">
                                                ...
                                                <h5 class="mb-0">--</h5>
                                                @endif
                                                <small class="mb-0">Date de la prochaine Expédition</small> <br>
                                                    ...
                                                    @if (Carbon\Carbon::parse($firstLatestExpedition) < Carbon\Carbon::now())
                                                        <span class="text-danger">
                                                            ...
                                                            @if ($latestExpedition->statut == 'started')
                                                                <span class="badge bg-warning text-warning-light">Démarrage</span>
                                                            @endif
                                                            @if ($latestExpedition->statut == 'startedDoc')
                                                                <span class="badge bg-primary text-primary-light">Démarrage Documennt</span>
                                                            @endif
                                        ...
                                        <div class="col">
                                            <div class="p-3">
                                                <h5 class="mb-0">{{ number_format($averageDelayTransport, 2) }} /jour</h5>
                            ...
                            <div class="col-12 col-lg-4 d-flex">
                                <div class="card radius-10 w-100">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <h6 class="mb-0">Rapport d'expédition</h6>
                                            </div>
                                            <!--<div class="dropdown ms-auto">
                                                <a class="dropdown-toggle dropdown-toggle-nocaret" href="#"
                                                    data-bs-toggle="dropdown"><i
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">Les (5) plus Récents</h5>
                    </div>
                                ...
                                <td>
                                    @if ($item->statut == 'draft')
                                        ...
                                        @if ($item->statut == 'started')
                                            <span class="badge bg-warning text-warning-light px-3 py-1">Démarrage</span>
                                        @endif
                                        @if ($item->statut == 'startedDoc')
                                            <span class="badge bg-primary text-primary-light px-3 py-1">Démarrage Documennt</span>
                                        @endif
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div
                                                class="badge rounded-pill text-success bg-light-success p-2 text-uppercase px-3 border-0">
                                                <i class='bx bxs-circle me-1'></i>Démarrer
                                            </div>
                                            @endif
            ...
            <div class="card-body">
						...
						<div class="card radius-10 w-100">
							<div class="card-body">
								<div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3">
									...
									<span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1"
											style="color: #07ff5e"></i>Payées</span>
								</div>
                ...
                <div class="card radius-10">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <div>
                                <h6 class="mb-0">Dernières Factures Prestataires</h6>
                            </div>
                            <!--<div class="dropdown ms-auto">
            ...
            <div class="card-body">
                <div class="fm-search row">
                    <div class="mb-0 col-lg-10">
                        <strong class="text-uppercase">Facture Client</strong>
                    </div>
                    ...
                    <div class="col">
                        <div class="card radius-10 border-start border-0 border-4 border-info">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-secondary">Valeur Totale des Factures</p>
                                        <h4 class="my-1 text-info size_12">
...
<!--<script>
    var totauxFournisseurParMois = [{{ implode(',', $montantsFournisseurParMois) }}];
    var totauxFournisseurDeboursParMois = [{{ implode(',', $montantFournisseurDeboursParMois) }}];
    var totauxFournisseurPrestationParMois = [{{ implode(',', $montantFournisseurPrestationParMois) }}];
    var totauxPrestataireParMois = [{{ implode(',', $montantsPrestataireParMois) }}];
    var totauxPrestatairePayedParMois = [{{ implode(',', $montantsPrestatairePayedParMois) }}];
...
<script>
    ...
    var ctx = document.getElementById('chart5Four').getContext('2d');
...
<script>
    ...
    console.log("totalllllllllllllllllllllllllllllllllllllll",totauxPrestataireParMois);
