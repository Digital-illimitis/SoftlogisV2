                                            ...
                                            <div class="border border-3 p-4 rounded">
                                                ...
                                                <!--<div class="row col-12 d-flex wrap mx-auto">
                                                        <div class="col-sm-12 col-md-4 col-lg-4">
                                                            ...
                                                            <input class="form-control" type="date" name="date_reception" id="date_reception" placeholder="Date de Reception" />
                                                        </div>
                                                        <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                                            ...
                                                            <input type="date" class="form-control" id="inputProductTitle"
                                                                placeholder="Date d'entrée en stock" name="date_stockage">
                                                        </div>
                                                        <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                                            <label for="inputProductTitle" class="form-label">Date de Sortie du Stock</label>
                                                            <input type="date" class="form-control" id="inputProductTitle"
                                                                placeholder="Date de Sortie du Stock" name="date_outStock" >
